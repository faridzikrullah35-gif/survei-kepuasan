    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <nav class="flex mt-2 text-sm">
                ...
                <span class="text-gray-500">Tambahkan Tahun Akademik</span>
            </nav>
        </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-xl font-semibold text-gray-800">Tambah Tahun Akademik</h2>
            </div>
            
            <div class="p-6">
                <form action="{{ route('tahun_akademik.store') }}" method="POST" class="space-y-6">
                    @csrf
