...
<div class="min-h-screen bg-gray-50 py-12">
    <div class="max-w-lg mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li class="inline-flex items-center">
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('role-index.index') }}" class="ml-1 text-gray-700 hover:text-indigo-600 md:ml-2">Role</a>
                        </div>
                    </li>
        ...
        <!-- Tombol Kembali -->
        <a href="{{ route('role-index.index') }}" class="mb-6 inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
        ...
        <div class="bg-white shadow-xl rounded-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-600">Masukkan nama untuk role baru yang akan dibuat.</p>
            </div>
            ...
            <div class="p-6">
                ...
                <form method="POST" action="{{ route('role.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" id="name" name="name" placeholder="Contoh: admin" required
                                class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </div>
                        <p class="mt-2 text-sm text-gray-500">Jika role melebihi satu kata gunakan "_". Contoh "tenanga_kependidikan"</p>
                    </div>
