            ...
            <div class="p-6">
                ...
                <form method="POST" action="{{ route('role.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" id="name" name="name" placeholder="Contoh: Content Writer" required
                                class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </div>
                        <p class="mt-2 text-sm text-gray-500">Gunakan nama yang deskriptif dan mudah dipahami.</p>
                    </div>
